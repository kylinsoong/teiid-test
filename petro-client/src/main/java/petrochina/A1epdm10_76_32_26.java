...
public class A1epdm10_76_32_26 {
    
    private static final String JDBC_DRIVER = "oracle.jdbc.driver.OracleDriver";
    private static final String JDBC_URL = "jdbc:oracle:thin:@10.76.32.26:1521:a1epdm";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(A1epdm10_76_32_26.class + " Connection is Created");
        
        DatabaseMetaData metadata = conn.getMetaData();
        

        if(args.length > 0 && args[0].equals("console")) {
            TablesMeta meta = new TablesMeta("A1epdm10_76_32_26");
            ...
            try(
                    ...
                    ResultSetToCSVRender renderer = new ResultSetToCSVRender(tables, "a1epdm-10.76.32.26.csv");
                    ) {
                renderer.renderer();
            }
        }
        ...
        System.out.println(A1epdm10_76_32_26.class + " exit");
    }
