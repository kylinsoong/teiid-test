...
/**
 * The <code>ConnectorManager</code> manages an {@link ExecutionFactory} and its associated workers' state.
 * 
...
public class AutoGenDataService extends ConnectorManager {
    ...
    public AutoGenDataService() {
        ...
        caps = getTypicalCapabilities();
    }
    
    private SourceCapabilities getTypicalCapabilities() {
