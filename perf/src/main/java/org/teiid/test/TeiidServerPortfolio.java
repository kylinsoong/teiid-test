...
public class TeiidServerPortfolio {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RunScript.execute(ds.getConnection(), new InputStreamReader(TeiidServerPortfolio.class.getClassLoader().getResourceAsStream("h2-schema.sql")));
        ...
        server.deployVDB(TeiidServerPortfolio.class.getClassLoader().getResourceAsStream("portfolio-vdb.xml"));
