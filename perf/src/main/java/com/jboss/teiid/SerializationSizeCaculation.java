...
import org.teiid.test.util.SizeUtility;
...
public class SerializationSizeCaculation extends SerializationCaculation {
	...
	public void countSize() throws Exception {
		...
		try {
			...
			while(rs.next()) {
				...
				System.out.print(obj.getClass() + " -> " + new SizeUtility(null).getSize(obj, DataTypeManager.determineDataTypeClass(obj), true, false));
				obj = rs.getString(2);
				System.out.print(", " + obj.getClass() + " -> " + new SizeUtility(null).getSize(obj, DataTypeManager.determineDataTypeClass(obj), true, false));
				obj = rs.getString(3);
				System.out.print(", " + obj.getClass() + " -> " + new SizeUtility(null).getSize(obj, DataTypeManager.determineDataTypeClass(obj), true, false));
				rs.getString(4);
				System.out.println(", " + obj.getClass() + " -> " + new SizeUtility(null).getSize(obj, DataTypeManager.determineDataTypeClass(obj), true, false));
			}
		} catch (Exception e) {
			throw e;
		} finally {
	...
	public static void main(String[] args) throws Exception {
	 ...
	 public static long helpTestGetSize(Object obj) {  
		return new SizeUtility(null).getSize(obj, DataTypeManager.determineDataTypeClass(obj), true, false);
	}
