...
DROP TABLE IF EXISTS h2_stock_mat_1;
DROP TABLE IF EXISTS mat_stock_staging_1;
DROP TABLE IF EXISTS h2_stock_mat_2;
DROP TABLE IF EXISTS mat_stock_staging_2;
DROP TABLE IF EXISTS h2_stock_mat_3;
DROP TABLE IF EXISTS mat_stock_staging_3;
...
CREATE TABLE mat_stock_staging_1
(
   product_id integer,
   SYMBOL varchar(16),
   PRICE decimal(20,4),
...
CREATE TABLE mat_stock_staging_2
(
   product_id integer,
   SYMBOL varchar(16),
   PRICE decimal(20,4),
...
CREATE TABLE mat_stock_staging_3
(
   product_id integer,
   SYMBOL varchar(16),
   PRICE decimal(20,4),
