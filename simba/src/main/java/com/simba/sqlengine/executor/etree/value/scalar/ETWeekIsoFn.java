...
public class ETWeekIsoFn
  extends ETScalarFn
{
  public ETWeekIsoFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    else
    {
      ...
      paramETDataRequest.getData().setInteger(localGregorianCalendar.get(3));
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETWeekIsoFn.class
