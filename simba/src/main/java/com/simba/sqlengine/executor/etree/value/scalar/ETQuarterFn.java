...
public final class ETQuarterFn
  extends ETScalarFn
{
  public ETQuarterFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    {
      int i = 1 + localISqlDataWrapper.getDate().getMonth() / 3;
      assert ((1 <= i) && (i <= 4));
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETQuarterFn.class
