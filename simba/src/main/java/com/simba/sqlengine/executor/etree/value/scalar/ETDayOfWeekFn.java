...
public final class ETDayOfWeekFn
  extends ETScalarFn
{
  public ETDayOfWeekFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    {
      int i = localISqlDataWrapper.getDate().getDay() + 1;
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETDayOfWeekFn.class
