...
public final class ETHourFn
  extends ETScalarFn
{
  public ETHourFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    {
      int i = localISqlDataWrapper.getTime().getHours();
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETHourFn.class
