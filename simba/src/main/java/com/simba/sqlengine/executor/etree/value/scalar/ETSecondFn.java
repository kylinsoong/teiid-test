...
public final class ETSecondFn
  extends ETScalarFn
{
  public ETSecondFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    throws ErrorException
  {
    super(paramIColumn, paramList, paramList1);
    if ((1 != paramList.size()) || (1 != paramList1.size())) {
      throw new IllegalArgumentException("Invalid Number of arguments for SECOND scalar function.");
    }
    ...
    throws ErrorException
  {
    ...
    {
      int i = localISqlDataWrapper.getTime().getSeconds();
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETSecondFn.class
