...
public class ETRTrim
  extends ETScalarFn
{
  public ETRTrim(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    int i = str.length();
    for (int j = str.length() - 1; (j >= 0) && (Character.isWhitespace(str.charAt(j))); j--) {
      i--;
    }
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETRTrim.class
