...
public class TinyIntBoolEqFunctor
  implements IBooleanCompFunctor
{
    ...
    throws ErrorException
  {
    ...
    int i = paramISqlDataWrapper1.getTinyInt();
    int j = paramISqlDataWrapper2.getTinyInt();
    return i == j ? ETBoolean.SQL_BOOLEAN_TRUE : ETBoolean.SQL_BOOLEAN_FALSE;
  }
}


/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/bool/functor/comp/TinyIntBoolEqFunctor.class
