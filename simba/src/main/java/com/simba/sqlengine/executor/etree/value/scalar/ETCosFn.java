...
public final class ETCosFn
  extends ETScalarFn
{
  public ETCosFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    if (localISqlDataWrapper.isNull()) {
      ...
      paramETDataRequest.getData().setDouble(Math.cos(localISqlDataWrapper.getDouble()));
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETCosFn.class
