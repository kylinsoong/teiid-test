...
public final class ETDayOfMonthFn
  extends ETScalarFn
{
  public ETDayOfMonthFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    throws ErrorException
  {
    super(paramIColumn, paramList, paramList1);
    if ((1 != paramList.size()) || (1 != paramList1.size())) {
      throw new IllegalArgumentException("Invalid Number of arguments for DAYOFMONTH scalar function.");
    }
    ...
    throws ErrorException
  {
    ...
    {
      int i = localISqlDataWrapper.getDate().getDate();
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETDayOfMonthFn.class
