  ...
  extends DefaultSqlDataWrapper
{
    ...
    throws ErrorException
  {
    ...
    if (this.m_isNull)
    {
      paramDataWrapper.setNull(-6);
      return;
    }
    paramDataWrapper.setTinyInt(this.m_data);
  }
}


/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/datawrapper/SqlTinyIntDataWrapper.class
