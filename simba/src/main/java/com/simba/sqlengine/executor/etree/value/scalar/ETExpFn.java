...
public final class ETExpFn
  extends ETScalarFn
{
  public ETExpFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    if (localISqlDataWrapper.isNull()) {
      ...
      paramETDataRequest.getData().setDouble(Math.exp(localISqlDataWrapper.getDouble()));
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETExpFn.class
