...
public class DecimalMultiplyFunctor
  extends AbstractDecimalBinArithFunctor
{
  ...
  {
    BigDecimal localBigDecimal = paramBigDecimal1.multiply(paramBigDecimal2);
    return ExactNumConverter.setPrecScale(localBigDecimal, paramShort1, paramShort2, paramConversionResult);
  }
}


/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/functor/arithmetic/DecimalMultiplyFunctor.class
