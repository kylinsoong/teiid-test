...
public class ETWeekFn
  extends ETScalarFn
{
  public ETWeekFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    else
    {
      ...
      localGregorianCalendar.setTimeInMillis(localDate.getTime());
      int i = localGregorianCalendar.get(6);
      i += 7 - localGregorianCalendar.get(7);
      localGregorianCalendar.set(2, 0);
      localGregorianCalendar.set(5, 1);
      if (1 != localGregorianCalendar.get(7)) {
        i += 7;
      }
      paramETDataRequest.getData().setInteger(i / 7);
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETWeekFn.class
