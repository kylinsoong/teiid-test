...
public class ETSqrtFn
  extends ETScalarFn
{
  public ETSqrtFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    throws ErrorException
  {
    super(paramIColumn, paramList, paramList1);
    assert (((IColumn)paramList1.get(0)).getTypeMetadata().isApproximateNumericType());
    assert (paramIColumn.getTypeMetadata().isApproximateNumericType());
  }
    ...
    throws ErrorException
  {
    ...
    else
    {
      ...
      paramETDataRequest.getData().setDouble(Math.sqrt(d));
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETSqrtFn.class
