...
public class DateAddBigIntFunctor
  implements IBinaryArithmeticFunctor
{
    ...
    throws ErrorException
  {
    ...
    paramETDataRequest.getData().setDate(DateTimeFunctorUtil.datePlusBigInteger(localDate, localBigInteger));
    return false;
  }
}


/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/functor/arithmetic/DateAddBigIntFunctor.class
