...
public class ETACosFn
  extends ETScalarFn
{
  public ETACosFn(IColumn paramIColumn, List<ETValueExpr> paramList, List<IColumn> paramList1)
    ...
    throws ErrorException
  {
    ...
    else
    {
      ...
      paramETDataRequest.getData().setDouble(Math.acos(d));
    }
    return false;
  }
}
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/sqlengine/executor/etree/value/scalar/ETACosFn.class
