...
{
  public AsciiDataStream(InputStream paramInputStream, long paramLong, int paramInt, IWarningListener paramIWarningListener)
  {
    ...
    throws SQLException
  {
    ...
    if (-1L != this.m_streamLength)
    {
      ...
      if (12 == this.m_type) {
        ((DataWrapper)localObject2).setVarChar(new String((byte[])localObject1));
      } else {
        ((DataWrapper)localObject2).setLongVarChar(new String((byte[])localObject1));
      }
...
/* Location:              /home/kylin/work/couchbase/Driver/CouchbaseJDBC4.jar!/com/simba/streams/resultsetinput/AsciiDataStream.class
