...
public class TEIID4682Presto {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.deployVDB(TEIID4682Presto.class.getClassLoader().getResourceAsStream("teiid4682-vdb.xml"));
        
        Connection conn = server.getDriver().connect("jdbc:teiid:TEIID4682", null);
